...
- **Category**: Nominal
- **Standard**: ISO 27001 A.9.2.1
- **Preconditions**: Parent group `G_PARENT` exists in tenant `T1`
- **Input**:
  ```json
  POST /groups
  {
...
- **Category**: Nominal
- **Preconditions**: Group `G1` exists in tenant `T1`
...
- **Category**: Nominal
- **Preconditions**: Group `G1` exists with `display_name = "Engineering"`
- **Input**:
  ```json
  PUT /groups/<G1-uuid>
  {
...
- **Preconditions**: Group `G1` exists with no child groups
...
- **Category**: Edge Case
- **Preconditions**: Group "Engineering" exists in tenant `T1`
...
- **Category**: Edge Case
- **Preconditions**: "Engineering" exists in T1
...
- **Category**: Edge Case
- **Preconditions**: Group `G_PARENT` has child group `G_CHILD`
...
- **Category**: Edge Case
- **Preconditions**: 10 levels of nested groups already exist
...
- **Category**: Edge Case
- **Preconditions**: G1 -> G2 -> G3 hierarchy
...
- **Category**: Edge Case
- **Preconditions**: Group `G_OTHER` in tenant `T2`
...
- **Category**: Edge Case
- **Preconditions**: Tenant `T1` has no groups
- **Input**: `GET /groups`
...
- **Preconditions**: Group `G1` belongs to tenant `T1`; admin JWT for tenant `T2`
...
- **Category**: Security
- **Standard**: SOC 2 CC6.1
- **Preconditions**: T1 has groups A, B; T2 has groups X, Y
