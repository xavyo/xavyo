...
- **Preconditions**: Authenticated user (delegator) and delegate user exist
- **Input**:
  ```json
...
- **Category**: Nominal
- **Preconditions**: User has created delegations
- **Input**:
  ```
...
- **Category**: Nominal
- **Preconditions**: User is delegate for other users
- **Input**:
  ```
...
- **Preconditions**: Active delegation exists
- **Input**:
  ```
...
- **Preconditions**: Active delegation exists; delegator has pending approvals
- **Input**:
  ```
...
- **Preconditions**: Grantor and attorney users exist
- **Input**:
  ```json
...
- **Preconditions**: Active PoA exists; authenticated as attorney
- **Input**:
  ```
...
- **Category**: Nominal
- **Preconditions**: Currently assuming another identity
- **Input**:
  ```
...
- **Category**: Nominal
- **Preconditions**: Active PoA exists
- **Input**:
  ```json
...
- **Preconditions**: Admin authenticated; PoA exists
- **Input**:
  ```
...
- **Category**: Edge Case
- **Preconditions**: Delegation ends on March 15
- **Input**:
  ```json
...
- **Category**: Edge Case
- **Preconditions**: PoA is expired or revoked
- **Input**:
  ```
...
- **Preconditions**: Delegate user in different tenant
- **Input**:
  ```json
  POST /governance/delegations
...
- **Category**: Security
- **Preconditions**: PoA in tenant A; admin JWT for tenant B
- **Input**:
  ```
