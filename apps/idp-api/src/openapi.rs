...
#[openapi(
    ...
    paths(
        ...
        // Unified NHI (F108)
        xavyo_api_nhi::handlers::list::list_nhi,
        xavyo_api_nhi::handlers::get::get_nhi,
        xavyo_api_nhi::handlers::risk::get_risk_summary,
        // Unified NHI Certification (F108)
        xavyo_api_nhi::handlers::certification::create_campaign,
        xavyo_api_nhi::handlers::certification::list_campaigns,
        xavyo_api_nhi::handlers::certification::get_campaign,
        xavyo_api_nhi::handlers::certification::launch_campaign,
        xavyo_api_nhi::handlers::certification::cancel_campaign,
        xavyo_api_nhi::handlers::certification::list_campaign_items,
        xavyo_api_nhi::handlers::certification::decide_item,
        xavyo_api_nhi::handlers::certification::get_campaign_summary,
        xavyo_api_nhi::handlers::certification::bulk_decide,
        xavyo_api_nhi::handlers::certification::get_my_pending,
        // NHI Risk (F108)
        xavyo_api_nhi::handlers::risk::get_staleness_report,
        // NHI Service Accounts (F109)
        ...
        xavyo_api_nhi::handlers::service_accounts::suspend_service_account,
        xavyo_api_nhi::handlers::service_accounts::reactivate_service_account,
        xavyo_api_nhi::handlers::service_accounts::transfer_ownership,
        xavyo_api_nhi::handlers::service_accounts::certify_service_account,
        xavyo_api_nhi::handlers::service_accounts::get_service_account_summary,
        xavyo_api_nhi::handlers::service_accounts::list_credentials,
        xavyo_api_nhi::handlers::service_accounts::get_credential,
        xavyo_api_nhi::handlers::service_accounts::rotate_credentials,
        xavyo_api_nhi::handlers::service_accounts::revoke_credential,
        xavyo_api_nhi::handlers::service_accounts::record_usage,
        xavyo_api_nhi::handlers::service_accounts::list_usage,
        xavyo_api_nhi::handlers::service_accounts::get_usage_summary,
        xavyo_api_nhi::handlers::service_accounts::get_risk_score,
        xavyo_api_nhi::handlers::service_accounts::calculate_risk_score,
        xavyo_api_nhi::handlers::service_accounts::list_requests,
        xavyo_api_nhi::handlers::service_accounts::submit_request,
        xavyo_api_nhi::handlers::service_accounts::get_request,
        xavyo_api_nhi::handlers::service_accounts::get_my_pending_requests,
        xavyo_api_nhi::handlers::service_accounts::get_request_summary,
        xavyo_api_nhi::handlers::service_accounts::approve_request,
        xavyo_api_nhi::handlers::service_accounts::reject_request,
        xavyo_api_nhi::handlers::service_accounts::cancel_request,
        // NHI Agents (F109)
        ...
        xavyo_api_nhi::handlers::agents::suspend_agent,
        xavyo_api_nhi::handlers::agents::reactivate_agent,
        xavyo_api_nhi::handlers::agents::authorize_agent,
        xavyo_api_nhi::handlers::agents::list_agent_permissions,
        xavyo_api_nhi::handlers::agents::grant_agent_permission,
        xavyo_api_nhi::handlers::agents::revoke_agent_permission,
        xavyo_api_nhi::handlers::agents::query_agent_audit,
        xavyo_api_nhi::handlers::agents::get_security_assessment,
        xavyo_api_nhi::handlers::agents::list_anomalies,
        xavyo_api_nhi::handlers::agents::get_baseline,
        xavyo_api_nhi::handlers::agents::get_thresholds,
        xavyo_api_nhi::handlers::agents::update_thresholds,
        xavyo_api_nhi::handlers::agents::reset_thresholds,
        xavyo_api_nhi::handlers::agents::get_tenant_thresholds,
        xavyo_api_nhi::handlers::agents::set_tenant_thresholds,
        // NHI Agent Credentials (F110)
        xavyo_api_nhi::handlers::agents::list_agent_credentials,
        xavyo_api_nhi::handlers::agents::get_agent_credential,
        xavyo_api_nhi::handlers::agents::rotate_agent_credentials,
        xavyo_api_nhi::handlers::agents::revoke_agent_credential,
        xavyo_api_nhi::handlers::agents::validate_agent_credential,
        // NHI Tools (F109)
        ...
        // NHI Approvals (F109)
        xavyo_api_nhi::handlers::approvals::list_approvals,
        xavyo_api_nhi::handlers::approvals::get_approval,
        xavyo_api_nhi::handlers::approvals::check_approval_status,
        xavyo_api_nhi::handlers::approvals::approve_request,
        xavyo_api_nhi::handlers::approvals::deny_request,
    ...
    components(schemas(
        ...
        // Unified NHI models (F108)
        xavyo_api_nhi::NhiListResponse,
        xavyo_api_nhi::NhiItem,
        xavyo_api_nhi::RiskSummaryResponse,
        xavyo_api_nhi::CountByType,
        xavyo_api_nhi::CountByRiskLevel,
        // Unified NHI Certification models (F108)
        xavyo_api_nhi::CreateCampaignRequest,
        xavyo_api_nhi::CampaignFilterRequest,
        xavyo_api_nhi::CampaignResponse,
        xavyo_api_nhi::CampaignListResponse,
        xavyo_api_nhi::ItemCountsResponse,
        xavyo_api_nhi::CertificationItemResponse,
        xavyo_api_nhi::ItemListResponse,
        xavyo_api_nhi::DecisionRequest,
        xavyo_api_nhi::CertErrorResponse,
        // NHI Certification additional models (F108)
        xavyo_api_nhi::handlers::certification::CampaignSummaryResponse,
        xavyo_api_nhi::handlers::certification::BulkDecisionRequest,
        xavyo_api_nhi::handlers::certification::BulkDecisionResponse,
        xavyo_api_nhi::handlers::certification::MyPendingItemsResponse,
    ))
)]
pub struct ApiDoc;
