...
- **Preconditions**: Authenticated admin user in tenant
- **Input**:
  ```json
...
- **Category**: Nominal
- **Preconditions**: Tenant has 3 API keys (2 active, 1 deactivated)
...
- **Category**: Nominal
- **Preconditions**: API key created and active
...
- **Category**: Edge Case
- **Preconditions**: Key named "My Key" exists
...
- **Category**: Edge Case
- **Preconditions**: Key already deactivated
- **Input**: `DELETE /tenants/:tenant_id/api-keys/:key_id`
...
- **Category**: Edge Case
- **Preconditions**: API key with past `expires_at`
...
- **Category**: Edge Case
- **Preconditions**: 50 API keys exist
...
- **Category**: Security
- **Preconditions**: Authenticated as regular user (no admin role)
...
- **Category**: Security
- **Preconditions**: Tenant A has API key K1
...
- **Category**: Security
- **Preconditions**: Key has scope `read:users` only
