...
- **Category**: Nominal
- **Preconditions**: API key K1 has been used for 50 requests over 7 days
...
- **Category**: Nominal
- **Preconditions**: API key created but never used
- **Input**: `GET /tenants/:tenant_id/api-keys/:key_id/usage`
- **Expected Output**:
  ```
  Status: 200 OK
...
- **Category**: Nominal
- **Preconditions**: Authenticated via API key
...
- **Category**: Nominal
- **Preconditions**: API key with scopes `["read:users"]`
...
- **Category**: Edge Case
- **Preconditions**: API key has been deactivated
...
- **Category**: Security
- **Preconditions**: Key K1 belongs to tenant A
