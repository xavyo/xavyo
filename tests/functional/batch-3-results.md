...
| Test Case | Result | Details |
|-----------|--------|---------|
| TC-OAUTH-CL-001 | PASS | 200, client_id=8950eab84394431aa8c2bf9c7cf41236 |
| TC-OAUTH-CL-002 | PASS | 200, public client (no secret) |
| TC-OAUTH-CL-003 | PASS | 200, total=78 clients |
...
| TC-OAUTH-CC-006 | PASS | JWT valid: sub=8950eab84394431aa8c2bf9c7cf41236, iss=http://localhost:8080, tid=00000000-0000-0000-0000-000000000001 |
...
| TC-OAUTH-TI-001 | PASS | active=true, sub=8950eab84394431aa8c2bf9c7cf41236, scope=read write admin |
...
| TC-OAUTH-DC-001 | PASS | 200, user_code=CRV9-P5N7, expires=600, interval=5 |
| TC-OAUTH-DC-002 | PASS | 200, with scopes |
| TC-OAUTH-DC-003 | PASS | Format XXXX-XXXX: CRV9-P5N7 |
...
| TC-MFA-TOTP-001 | PASS | 200, secret=G3YAVHRV..., otpauth=yes |
