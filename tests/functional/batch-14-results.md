...
|---------|--------|---------|
| TC-F202-001 | PASS | Created admin API key id=7be3130e-2c68-4778-8ebc-c52ba4d08ebc |
| TC-F202-002 | PASS | Admin key can access /admin/users (role inherited) |
| TC-F202-003 | PASS | Admin key can access /nhi |
| TC-F202-004 | PASS | Created scoped key id=a798f590-e977-4657-b690-277f93268dc1 scope=[nhi:read] |
...
| TC-F202-009 | PASS | Created wildcard NHI key id=2ad2dea6-e4a7-442f-8a42-4b4b5ddd7a48 scope=[nhi:*] |
| TC-F202-010 | PASS | nhi:* key can POST /nhi/agents, agent=a5f9a090-0a71-4582-98bd-79eb3b3d3c34 |
...
| TC-F205-A2A-003 | PASS | Created A2A task id=afc92489-9cb1-4565-985e-21d8d64d2329 |
...
| TC-F205-DISC-001 | PASS | AgentCard returned for perm-test-agent-1770724819 |
| TC-F205-DISC-002 | PASS | AgentCard has name=perm-test-agent-1770724819 type=null |
