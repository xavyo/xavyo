...
PASS=67 FAIL=1 SKIP=0 TOTAL=68

| Test ID | Result | Details |
|---------|--------|---------|
| TC-201-UNI-001 | PASS | 200, unified list returned (total=15) |
| TC-201-UNI-002 | PASS | 200, count increased from 15 to 18 (created 3) |
...
| TC-201-AGT-001 | PASS | 201, agent created without team (id=e465f47a-98cf-43b3-9e75-6b43ab851c42) |
| TC-201-AGT-002 | PASS | 200, agent retrieved (name=agt-no-team-1771190748, type=copilot) |
| TC-201-AGT-003 | PASS | 200, agent updated (model=claude-opus-4-6) |
| TC-201-AGT-004 | PASS | 200, agents listed (total=17) |
| TC-201-AGT-005 | PASS | 201, autonomous agent created (id=25a65fa4-7448-4cd6-a501-2f9f1be2e01a) |
| TC-201-AGT-006 | PASS | 201, orchestrator agent created (id=371e4df6-7cf1-4658-8f55-3b0eb9008a9d) |
...
| TC-201-CERT-001 | PASS | 201, campaign created with scope=all (id=7a120908-954c-44eb-911b-ca836818e91e) |
| TC-201-CERT-002 | PASS | 201, campaign created with scope=by_type (id=9c3d0fd3-c000-4c6b-b5dc-de225cbf5036) |
| TC-201-CERT-003 | PASS | 201, campaign created with scope=specific (id=3d4e4044-457a-46f7-9d1d-e6105a08b5d1) |
...
| TC-201-CERT-008 | PASS | 200, NHI certified in all-scope campaign (at=2026-02-15T21:25:52.781384361Z) |
...
| TC-201-RISK-001 | PASS | 200, risk summary retrieved (total_entities=24) |
...
| TC-201-INACT-003 | FAIL | Expected 200, got 500 |
...
| TC-201-SOD-001 | PASS | 201, SoD rule created id=23243c2d-115a-4727-80fc-97635c2ad183 |
...
Generated: 2026-02-15 21:25:53 UTC
