...
- **Special Setup**: User must be authenticated; tenant MFA policy affects disable tests

## Nominal Cases

### TC-MFA-TOTP-001: Initiate TOTP setup
- **Category**: Nominal
- **Preconditions**: Fixtures: `USER_JWT`, `TEST_TENANT`. Authenticated user, no MFA enrolled
...
- **Category**: Nominal
- **Preconditions**: Fixtures: `USER_JWT`, `TEST_TENANT`. TOTP setup initiated
- **Input**:
  ```json
...
- **Category**: Nominal
- **Preconditions**: Fixtures: `REGULAR_USER`, `TEST_TENANT`. User has TOTP enrolled
- **Input**:
...
- **Category**: Nominal
- **Preconditions**: Fixtures: `USER_JWT`, `TEST_TENANT`. TOTP enrolled, tenant policy allows disabling
- **Input**:
  ```json
...
- **Category**: Nominal
- **Preconditions**: Fixtures: `REGULAR_USER`, `TEST_TENANT`. TOTP enrolled, user has recovery codes
...
- **Category**: Edge Case
- **Preconditions**: Fixtures: `REGULAR_USER`, `TEST_TENANT`. MFA challenge issued, wait > token TTL
...
- **Category**: Edge Case
- **Preconditions**: Fixtures: `ADMIN_JWT`, `TEST_TENANT`. Tenant MFA policy = required
...
- **Category**: Edge Case
- **Preconditions**: Fixtures: `REGULAR_USER`, `TEST_TENANT`. All 10 recovery codes used
...
- **Category**: Security
- **Preconditions**: Fixtures: `USER_JWT`, `TEST_TENANT`. User has MFA enabled
