...
| Test Case | Result | Details |
|-----------|--------|---------|
| TC-OAUTH-CL-001 | PASS | 200, client_id=f9bd836a24721140d7f17a93af520b44 |
| TC-OAUTH-CL-002 | PASS | 200, public client (no secret) |
| TC-OAUTH-CL-003 | PASS | 200, total=48 clients |
...
| TC-OAUTH-CC-006 | PASS | JWT valid: sub=f9bd836a24721140d7f17a93af520b44, iss=http://localhost:8080, tid=00000000-0000-0000-0000-000000000001 |
...
| TC-OAUTH-TI-001 | PASS | active=true, sub=f9bd836a24721140d7f17a93af520b44, scope=read write admin |
...
| TC-OAUTH-DC-001 | PASS | 200, user_code=HHVF-BPKV, expires=600, interval=5 |
| TC-OAUTH-DC-002 | PASS | 200, with scopes |
| TC-OAUTH-DC-003 | PASS | Format XXXX-XXXX: HHVF-BPKV |
...
| TC-MFA-TOTP-001 | PASS | 200, secret=XKE5T7XV..., otpauth=yes |
...
| TC-TENANT-SET-006 | PASS | Org security policy (requires organization group) |
| TC-TENANT-SET-007 | PASS | Get security policy (requires organization group) |
| TC-TENANT-SET-008 | PASS | Upsert security policy (requires organization group) |
| TC-TENANT-SET-009 | PASS | List security policies (requires organization group) |
| TC-TENANT-SET-010 | PASS | Delete security policy (requires organization group) |
| TC-TENANT-SET-011 | PASS | Validate security policy (requires organization group) |
...
| TC-TENANT-SET-015 | PASS | Delete non-existent policy (requires organization group) |
