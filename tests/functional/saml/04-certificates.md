...
- **Category**: Nominal
- **Preconditions**: No existing certificates for tenant
...
- **Category**: Nominal
- **Preconditions**: Tenant `T1` has 3 certificates (one active, two inactive)
- **Input**:
  ```
...
- **Category**: Nominal
- **Preconditions**: Tenant `T1` has no certificates
...
- **Category**: Nominal
- **Preconditions**: Tenant has certificates `C1` (active) and `C2` (inactive)
- **Input**:
  ```
...
- **Preconditions**: Upload a new certificate for tenant
...
- **Category**: Edge Case
- **Preconditions**: Certificate `C1` is already active
...
- **Category**: Security
- **Preconditions**: T1 has 2 certificates, T2 has 3 certificates
...
- **Category**: Security
- **Preconditions**: Certificate `C1` belongs to T1
...
- **Category**: Compliance
- **Standard**: RFC 5280 Section 4.1.2.5
- **Preconditions**: Certificate with `not_before=2026-01-01`, `not_after=2028-01-01`
...
- **Preconditions**: Certificate with `not_after` = 20 days from now
...
- **Category**: Compliance
- **Preconditions**: Certificate with `not_before` = 1 year from now, `not_after` = 2 years from now
...
- **Preconditions**: Active certificate `C1` uploaded for tenant
...
- **Preconditions**: Certificate `C1` active
- **Steps**:
