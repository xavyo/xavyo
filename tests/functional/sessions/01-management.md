...
- **Preconditions**: Authenticated user with at least one active session
...
- **Category**: Nominal
- **Preconditions**: User logged in from two different devices/browsers
...
- **Category**: Nominal
- **Standard**: OWASP ASVS 3.3.1
- **Preconditions**: User has two active sessions (session A = current, session B = other device)
...
- **Category**: Nominal
- **Preconditions**: User logs in from known IP and User-Agent
- **Input**: `GET /me/sessions`
...
- **Category**: Nominal
- **Preconditions**: User has 2 active sessions
...
- **Preconditions**: User A and User B each have sessions
...
- **Category**: Edge Case
- **Preconditions**: Somehow all sessions are expired (should not happen if currently authenticated)
- **Input**: `GET /me/sessions`
...
- **Category**: Edge Case
- **Preconditions**: Session B exists
...
- **Preconditions**: Tenant has max_sessions_per_user = 5
...
- **Category**: Edge Case
- **Preconditions**: Token has been revoked via session revocation
...
- **Category**: Edge Case
- **Preconditions**: User has only the current session
- **Input**: `DELETE /me/sessions`
...
- **Category**: Security
- **Preconditions**: User in tenant A, sessions exist in tenant B
- **Input**: `GET /me/sessions`
