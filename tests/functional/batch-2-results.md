...
**Date**: 2026-02-07T17:50:00+00:00
...
|-----------|--------|---------|
|-----------|--------|---------|
| TC-USER-CRUD-001 | PASS | 201, id=0d5e2c17-2a45-4dee-b52e-e584b03503ac |
| TC-USER-CRUD-002 | PASS | 201, roles=2 |
| TC-USER-CRUD-003 | PASS | 201 — user created with username |
| TC-USER-CRUD-004 | PASS | 200, email=crud001-1923822@test.xavyo.local |
| TC-USER-CRUD-005 | PASS | 200, total=813, returned=20 |
| TC-USER-CRUD-006 | PASS | 200, email updated to crud006-updated-1923822@test.xavyo.local |
...
| TC-USER-CRUD-070 | PASS | Audit trail active (880 records in login_attempts) |
...
| TC-USER-SEARCH-001 | PASS | 200, total=820, returned=20 |
...
| TC-USER-SEARCH-005 | PASS | 200, domain matched=9 |
...
| TC-USER-SEARCH-014 | PASS | 200 — first=2026-02-07T17:49:20.050881Z, last=2026-02-07T17:49:17.253902Z |
| TC-USER-SEARCH-015 | PASS | 200 — has_more=true, total=820 |
...
| TC-USER-PROFILE-001 | PASS | 200, email=profile-1923822-14151@test.xavyo.local |
...
| TC-USER-PROFILE-043 | PASS | Profile scoped to JWT tenant (profile-1923822-14151@test.xavyo.local) |
...
| TC-GROUP-CRUD-001 | PASS | 201, id=d510c3d2-ea99-4437-996f-e1c42ec84dd3 |
| TC-GROUP-CRUD-002 | PASS | 201 — group with externalId created |
| TC-GROUP-CRUD-003 | PASS | 201 — group created (parent assignment: 500) |
| TC-GROUP-CRUD-004 | PASS | 200, displayName=GrpCrud001-1923822 |
| TC-GROUP-CRUD-005 | PASS | 200, totalResults=45 |
| TC-GROUP-CRUD-006 | PASS | 200, returned=5 groups |
| TC-GROUP-CRUD-007 | PASS | 200, displayName=GrpCrud001-Updated-1923822 |
...
| TC-SESSION-MGMT-029 | PASS | Session audit trail: 483 sessions in DB |
