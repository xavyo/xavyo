...
|---------|--------|---------|
| TC-F202-001 | PASS | Created admin API key id=0d3118d8-c93f-442e-acdf-73909a5bdcfb |
| TC-F202-002 | PASS | Admin key can access /admin/users (role inherited) |
| TC-F202-003 | PASS | Admin key can access /nhi |
| TC-F202-004 | PASS | Created scoped key id=9e16f623-1ecb-42a2-a344-f2aeefb99d56 scope=[nhi:read] |
...
| TC-F202-009 | PASS | Created wildcard NHI key id=47ea02fc-790b-446d-9ef6-ee1c82a7a06c scope=[nhi:*] |
| TC-F202-010 | PASS | nhi:* key can POST /nhi/agents, agent=1ff78500-cdf0-4abe-91fd-294d9111b698 |
...
| TC-F204-UP-003 | SKIP | Missing SA or user |
| TC-F204-UP-004 | PASS | Listed 1 user(s) with access to agent |
| TC-F204-UP-005 | PASS | User has access to 2 NHI(s) |
...
| TC-F204-UP-011 | SKIP | Missing SA or user |
...
| TC-F204-NP-007 | SKIP | Missing NHI entities |
...
| TC-F204-ENF-007 | PASS | Non-admin /nhi/agents returns 1 filtered agent(s) |
...
| TC-F205-A2A-003 | PASS | Created A2A task id=67555db4-b2d2-4670-ba7d-555a9603f130 |
...
| TC-F205-DISC-001 | PASS | AgentCard returned for perm-test-agent-1770589496 |
| TC-F205-DISC-002 | PASS | AgentCard has name=perm-test-agent-1770589496 type=null |
