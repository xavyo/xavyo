...
- **Category**: Nominal
- **Preconditions**: Tenant has Google and Microsoft configured and enabled
...
- **Preconditions**: Google provider configured for tenant
...
- **Preconditions**: Google provider configured, user does not exist
...
- **Category**: Nominal
- **Preconditions**: User with matching email already exists and has Google connection
- **Input**: `GET /auth/social/google/callback?code=<auth_code>&state=<valid_state>`
...
- **Category**: Nominal
- **Preconditions**: Authenticated user without Google connection
- **Steps**:
...
- **Category**: Nominal
- **Preconditions**: User has Google and GitHub linked
...
- **Category**: Nominal
- **Preconditions**: User has Google linked and a password set (alternative login method)
...
- **Category**: Edge Case
- **Preconditions**: Google provider is disabled for this tenant
- **Input**: `GET /auth/social/google/authorize?tenant_id=<tid>`
...
- **Category**: Edge Case
- **Preconditions**: User A exists with email user@example.com
...
- **Category**: Edge Case
- **Preconditions**: User already has Google linked
...
- **Category**: Edge Case
- **Preconditions**: User has only Google linked, no password set
...
- **Category**: Security
- **Preconditions**: Google configured for tenant A only
