...
- **Category**: Nominal
- **Preconditions**: Active connector with valid credentials
...
- **Category**: Nominal
- **Preconditions**: Sync has been triggered and completed
...
- **Category**: Nominal
- **Preconditions**: Sync is disabled
...
- **Category**: Nominal
- **Preconditions**: Delta sync completed with 3 changes detected
...
- **Category**: Nominal
- **Preconditions**: Change failed with transient error
...
- **Category**: Security
- **Preconditions**: Connector belongs to tenant A
