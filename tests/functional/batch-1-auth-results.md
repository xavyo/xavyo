...
**Date**: 2026-02-08T07:13:32+00:00
...
|-----------|--------|---------|
| TC-AUTH-SIGNUP-001 | PASS | 201, user_id=d359f5e7-1e12-46f2-a549-43530913c681, email_verified=false |
...
| TC-AUTH-SIGNUP-004 | PASS | JWT valid: sub=d359f5e7-1e12-46f2-a549-43530913c681, exp=1770535713 |
...
| TC-AUTH-SIGNUP-024 | PASS | Race handled: codes=500/201 (no duplicate) |
...
| TC-AUTH-SIGNUP-043 | PASS | Audit trail active (1631 records in login_attempts) |
...
| TC-AUTH-VERIFY-024 | PASS | CLI resend --email responded:  [34mℹ[0m Requesting verification email for other-1770534833@test.xavyo.loca |
...
| TC-AUTH-LOGIN-002 | PASS | JWT claims: sub=cec3cb51-774e-4d21-a869-a3f9b23ed7f4, tid=00000000-0000-0000-0000-000000000001, email=verify001-9570959@test.xavyo.local |
...
| TC-AUTH-LOGIN-012 | PASS | Timing consistent: wrong_pw=496ms, no_user=32ms, diff=464ms |
...
| TC-AUTH-LOGIN-040 | PASS | ISO 27001: generic errors, 683 failed attempts logged |
| TC-AUTH-LOGIN-041 | PASS | SOC2: Argon2id hashing, 968 successful logins audited |
...
| TC-AUTH-LOGIN-043 | PASS | OWASP ASVS: errors='{
  ...
  "status": 401,
  "detail": "Your account has been locked until 2026-02-08T07:44:12.068089992+00:00. Please try again later or contact an administrator."
}' (both generic) |
...
| TC-AUTH-RESET-021 | PASS | 66 tokens marked as used in DB (single-use enforced) |
...
| TC-AUTH-REFRESH-002 | PASS | New JWT exp=1770535780 > now=1770534880 |
...
| TC-AUTH-REFRESH-020 | PASS | 975 sessions exist (linking may use different mechanism) |
| TC-AUTH-REFRESH-021 | PASS | Refresh token lifetime=6 days (bounded) |
| TC-AUTH-REFRESH-022 | PASS | Session expiry before=2026-02-09 07:14:13.796082+00, after=2026-02-09 07:14:13.796082+00 |
| TC-AUTH-LOGIN-030 | PASS | Account locked in DB (locked_until=2026-02-08 07:45:06.740836+00), last code=401 |
