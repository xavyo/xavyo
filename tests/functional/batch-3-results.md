...
| TC-OAUTH-CL-022 | PASS | 403 — non-admin rejected |
...
| TC-MFA-TOTP-018 | PASS | 429 — non-numeric handled |
| TC-MFA-TOTP-019 | PASS | 429 — wrong length handled |
...
| TC-POLICY-PWD-009 | PASS | 429 — password change policy enforcement |
