...
- **Preconditions**: Authenticated admin, user exists with multiple data records
...
- **Category**: Nominal
- **Preconditions**: User just created, no sessions or audit history
- **Input**: `GET /governance/gdpr/report?user_id=<uuid>`
...
- **Category**: Nominal
- **Preconditions**: User has active entitlements that prevent immediate erasure
- **Input**: `GET /governance/gdpr/users/:user_id/data-protection`
...
- **Category**: Edge Case
- **Preconditions**: User with 1000+ audit log entries, 50+ sessions
- **Input**: `GET /governance/gdpr/report?user_id=<uuid>`
...
- **Category**: Edge Case
- **Preconditions**: User has been soft-deleted
...
- **Category**: Security
- **Preconditions**: User belongs to tenant A
...
- **Preconditions**: Regular user (non-admin)
