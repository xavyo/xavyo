...
- **Preconditions**: Group `G1` and user `U1` exist in tenant `T1`; `U1` is not a member of `G1`
- **Input**:
  ```json
...
- **Category**: Nominal
- **Preconditions**: Group `G1` and users `U1`, `U2`, `U3` exist in tenant `T1`
...
- **Category**: Nominal
- **Preconditions**: Group `G1` has 3 members
...
- **Preconditions**: User `U1` is a member of group `G1`
- **Input**:
  ```json
...
- **Category**: Nominal
- **Standard**: ISO 27001 A.9.2.2
- **Preconditions**: Group `G1` has members U1, U2; want to set to U3, U4
...
- **Category**: Nominal
- **Preconditions**: Group `G1` has 5 members
...
- **Category**: Nominal
- **Preconditions**: User `U1` is NOT a member of group `G1`
- **Input**: `is_member(tenant_id, G1, U1)`
- **Expected Output**: Returns `false`

### TC-GROUP-MEMBERSHIP-009: Get user's groups
- **Category**: Nominal
- **Preconditions**: User `U1` belongs to groups G1 ("Engineering") and G2 ("Platform")
...
- **Category**: Nominal
- **Preconditions**: User `U1` has `display_name = "Alice"` and `email = "alice@example.com"`
...
- **Category**: Edge Case
- **Preconditions**: User `U1` is already in group `G1`
...
- **Category**: Edge Case
- **Preconditions**: User `U1` is NOT in group `G1`
...
- **Category**: Edge Case
- **Preconditions**: Group `G1` has no members
- **Input**: `GET /groups/<G1>/members`
...
- **Category**: Edge Case
- **Preconditions**: Group `G1` has 150 members
- **Input**: `GET /groups/<G1>/members`
...
- **Category**: Edge Case
- **Preconditions**: User `U1` is a member of 50 groups
- **Input**: `get_user_groups(tenant_id, U1)`
...
- **Preconditions**: Group `G1` in tenant `T1`; user `U2` in tenant `T2`; admin JWT for `T2`
...
- **Category**: Security
- **Standard**: SOC 2 CC6.1
- **Preconditions**: Group `G1` in tenant `T1`; user `U_OTHER` in tenant `T2`; admin JWT for `T1`
...
- **Category**: Security
- **Standard**: SOC 2 CC6.1
- **Preconditions**: Group `G1` with members in T1; admin JWT for T2
...
- **Category**: Compliance
- **Standard**: ISO 27001 A.9.2.6
- **Preconditions**: User `U1` is a member of groups G1, G2, G3; user is soft-deleted
