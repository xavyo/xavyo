...
- **Category**: Nominal
- **Preconditions**: 8 service accounts exist
...
- **Category**: Edge Case
- **Preconditions**: Service account "billing-sync-service" exists
...
- **Category**: Edge Case
- **Preconditions**: Service account has active credentials
- **Input**: `DELETE /nhi/service-accounts/<sa-id>`
...
- **Preconditions**: Service account in Tenant A
