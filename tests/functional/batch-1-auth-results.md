...
**Date**: 2026-02-08T08:15:55+00:00
...
|-----------|--------|---------|
| TC-AUTH-SIGNUP-001 | PASS | 201, user_id=3e9256db-ed83-4762-8c58-c4bb5c22a25e, email_verified=false |
...
| TC-AUTH-SIGNUP-004 | PASS | JWT valid: sub=3e9256db-ed83-4762-8c58-c4bb5c22a25e, exp=1770539456 |
...
| TC-AUTH-SIGNUP-043 | PASS | Audit trail active (1911 records in login_attempts) |
...
| TC-AUTH-VERIFY-024 | PASS | CLI resend --email responded:  [34mℹ[0m Requesting verification email for other-1770538576@test.xavyo.loca |
...
| TC-AUTH-LOGIN-002 | PASS | JWT claims: sub=40e401e5-2d24-4667-9827-f8469a41959e, tid=00000000-0000-0000-0000-000000000001, email=verify001-8291331@test.xavyo.local |
...
| TC-AUTH-LOGIN-012 | PASS | Timing consistent: wrong_pw=514ms, no_user=26ms, diff=488ms |
...
| TC-AUTH-LOGIN-040 | PASS | ISO 27001: generic errors, 807 failed attempts logged |
| TC-AUTH-LOGIN-041 | PASS | SOC2: Argon2id hashing, 1124 successful logins audited |
...
| TC-AUTH-LOGIN-043 | PASS | OWASP ASVS: errors='{
  ...
  "status": 401,
  "detail": "Your account has been locked until 2026-02-08T08:46:35.177409453+00:00. Please try again later or contact an administrator."
}' (both generic) |
...
| TC-AUTH-RESET-021 | PASS | 76 tokens marked as used in DB (single-use enforced) |
...
| TC-AUTH-REFRESH-002 | PASS | New JWT exp=1770539523 > now=1770538623 |
...
| TC-AUTH-REFRESH-020 | PASS | 1131 sessions exist (linking may use different mechanism) |
| TC-AUTH-REFRESH-021 | PASS | Refresh token lifetime=6 days (bounded) |
| TC-AUTH-REFRESH-022 | PASS | Session expiry before=2026-02-09 08:16:36.9737+00, after=2026-02-09 08:16:36.9737+00 |
| TC-AUTH-LOGIN-030 | PASS | Account locked in DB (locked_until=2026-02-08 08:47:30.208217+00), last code=401 |
