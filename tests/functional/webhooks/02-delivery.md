...
- **Fixtures Required**: `ADMIN_JWT`, `TEST_TENANT`, `WEBHOOK_SUB`
- **Special Setup**: Mock webhook target endpoint for delivery verification; circuit breaker tests require repeated failures
...
- **Category**: Nominal
- **Preconditions**: Fixtures: `ADMIN_JWT`, `TEST_TENANT`, `WEBHOOK_SUB`. Subscription exists for `user.created` events, target endpoint is reachable
- **Steps**:
...
- **Preconditions**: Fixtures: `ADMIN_JWT`, `TEST_TENANT`, `WEBHOOK_SUB`. Delivery completed to target endpoint
...
- **Category**: Nominal
- **Preconditions**: Fixtures: `ADMIN_JWT`, `TEST_TENANT`, `WEBHOOK_SUB`. Subscription has 10 past deliveries
...
- **Category**: Nominal
- **Preconditions**: Fixtures: `ADMIN_JWT`, `TEST_TENANT`, `WEBHOOK_SUB`. Delivery record exists
...
- **Preconditions**: Fixtures: `ADMIN_JWT`, `TEST_TENANT`, `WEBHOOK_SUB`. Target endpoint returns 500
...
- **Category**: Nominal
- **Preconditions**: Fixtures: `ADMIN_JWT`, `TEST_TENANT`, `WEBHOOK_SUB`. Target endpoint consistently fails, max retries exhausted
...
- **Category**: Nominal
- **Preconditions**: Fixtures: `ADMIN_JWT`, `TEST_TENANT`, `WEBHOOK_SUB`. DLQ entry exists, target endpoint is now healthy
...
- **Category**: Nominal
- **Preconditions**: Fixtures: `ADMIN_JWT`, `TEST_TENANT`, `WEBHOOK_SUB`. Multiple DLQ entries exist
- **Input**:
  ```json
...
- **Preconditions**: Fixtures: `ADMIN_JWT`, `TEST_TENANT`, `WEBHOOK_SUB`. Target endpoint fails 5 consecutive times
...
- **Category**: Nominal
- **Preconditions**: Fixtures: `ADMIN_JWT`, `TEST_TENANT`, `WEBHOOK_SUB`. Circuit breaker is open, cooldown period elapsed
...
- **Category**: Edge Case
- **Preconditions**: Fixtures: `ADMIN_JWT`, `TEST_TENANT`, `WEBHOOK_SUB`. Target returns 301/302
...
- **Category**: Edge Case
- **Preconditions**: Fixtures: `ADMIN_JWT`, `TEST_TENANT`, `WEBHOOK_SUB`. Target endpoint takes 30+ seconds to respond
...
- **Category**: Edge Case
- **Preconditions**: Fixtures: `ADMIN_JWT`, `TEST_TENANT`, `WEBHOOK_SUB`. New subscription with no deliveries
...
- **Category**: Edge Case
- **Preconditions**: Fixtures: `ADMIN_JWT`, `TEST_TENANT`, `WEBHOOK_SUB`. DLQ entry exists
...
- **Category**: Edge Case
- **Preconditions**: Fixtures: `ADMIN_JWT`, `TEST_TENANT`, `WEBHOOK_SUB`. Subscription is inactive
...
- **Preconditions**: Fixtures: `ADMIN_JWT`, `TEST_TENANT`, `WEBHOOK_SUB`. Deliveries completed
...
- **Category**: Security
- **Preconditions**: Fixtures: `ADMIN_JWT`, `TEST_TENANT`, `WEBHOOK_SUB`. Multiple tenants with subscriptions
...
- **Category**: Security
- **Preconditions**: Fixtures: `ADMIN_JWT`, `TEST_TENANT`. Multiple tenants with DLQ entries
...
- **Category**: Security
- **Preconditions**: Fixtures: `ADMIN_JWT`, `TEST_TENANT`, `WEBHOOK_SUB`. Target endpoint failing
