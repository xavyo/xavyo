...
- **Category**: Nominal
- **Preconditions**: 3 connectors exist (LDAP, Entra, REST)
...
- **Category**: Nominal
- **Preconditions**: LDAP connector configured with valid credentials
...
- **Category**: Nominal
- **Preconditions**: Connector exists with status "inactive"
...
- **Category**: Nominal
- **Preconditions**: Connector is active
...
- **Category**: Nominal
- **Preconditions**: Active LDAP connector with reachable server
...
- **Category**: Edge Case
- **Preconditions**: Connector is active with pending sync operations
- **Input**: `DELETE /connectors/:id`
...
- **Category**: Security
- **Preconditions**: Tenant A has connector C1
