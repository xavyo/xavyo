//! Password change handler for /me/password (F027).
//!
//! This is an alias endpoint that delegates to the main password change handler.
...
pub async fn me_password_change(
    ...
    tracing::info!(
        ...
        "Password changed successfully via /me/password"
    );
